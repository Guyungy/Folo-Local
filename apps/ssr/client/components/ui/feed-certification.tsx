    ...
    (feed.ownerUserId === me?.id ? (
      <Tooltip delayDuration={300}>
        <TooltipTrigger asChild>
          <i className={cn("i-mingcute-certificate-fill ml-1.5 shrink-0 text-accent", className)} />
        </TooltipTrigger>

        <TooltipPortal>
          <TooltipContent className="px-4 py-2">
            <div className="flex items-center text-base font-semibold">
              <i className="i-mingcute-certificate-fill mr-2 size-4 shrink-0 text-accent" />
