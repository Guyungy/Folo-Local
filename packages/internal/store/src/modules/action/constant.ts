...
export const availableActionMap: Record<ActionId, ActionAction> = {
  ...
  silence: {
    ...
    icon: "speaker.slash",
    iconClassname: "i-mingcute-volume-mute-line",
  },
  block: {
    value: "block",
    label: "actions.action_card.block",
    icon: "xmark.circle",
    iconClassname: "i-mingcute-delete-2-line",
  },
  star: {
    value: "star",
    label: "actions.action_card.star",
    icon: "star",
    iconClassname: "i-mingcute-star-line",
  },
  rewriteRules: {
    value: "rewriteRules",
    label: "actions.action_card.rewrite_rules",
    icon: "pencil.and.outline",
    iconClassname: "i-mingcute-quill-pen-line",
  ...
  webhooks: {
    ...
    iconClassname: "i-mingcute-webhook-line",
    onEnable: (index) => {
